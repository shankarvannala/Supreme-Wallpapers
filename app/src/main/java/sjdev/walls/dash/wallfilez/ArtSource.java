...
import sjdev.walls.dash.Prefer;
...
public class ArtSource extends RemoteMuzeiArtSource {
    ...
    private static final String ARTSOURCE_NAME = "Supreme";
    private static final String JSON_URL = "https://raw.githubusercontent.com/shankarvannala/sjwalls/master/bokeh01/mu/supreme.json";
    ...
    public void onCreate() {
        ...
        mPrefs = new Prefer(ArtSource.this);
        ...
        if (wallslist.size() == 0) {
            try {
                ...
                if (response.getStatusLine().getStatusCode() == 200) {
                    ...
                    final JSONArray jsonarray = jsonobject.getJSONArray("sw");
                    wallslist.clear();
